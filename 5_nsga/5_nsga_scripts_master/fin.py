...
def compute_financials(
    ...
    for year in range(years):
        ...
        annual_costs.append({
            ...
            'total_cost': year_electricity_cost + annual_maintenance,
            'no_pv_cost': year_no_pv_cost,
            'pv_only_cost': year_pv_only_cost,
            'savings_vs_no_pv': year_no_pv_cost - year_electricity_cost - annual_maintenance,
            'savings_vs_pv_only': year_pv_only_cost - year_electricity_cost - annual_maintenance
        })
    ...
    if total_savings_vs_pv_only > 0:
        simple_payback = capex_total / (total_savings_vs_pv_only / years)
    else:
