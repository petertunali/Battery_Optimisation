...
def compute_financials(
    ...
    """
    Compute lifecycle CAPEX, OPEX, revenues/costs, IRR, NPV & PI over 'years'.
    ...
    if capex_total > 0:
        profitability_index = npv_value / capex_total
    else:
        profitability_index = float('inf') if npv_value >= 0 else float('-inf')
    ...
    return {
        ...
        'irr': irr_value,
        'profitability_index': profitability_index,  # Added PI calculation
