...
def evaluate_solution(params, pv_profile, demand_profile):
    ...
    # Calculate PI for later use (but don't return it as an objective)
    pi = fin['profitability_index'] if 'profitability_index' in fin else 0.0
    
    return [-irr, -npv]  # Only return IRR and NPV for optimization